# API/ml/services/data_preprocess
import glob
import logging
...
transformer_saved_path = PATH_CONFIG.RESULT_ML_PREPROCESS_TRANS_DIR
data_saved_path = PATH_CONFIG.RESULT_ML_PREPROCESSED_DATA_DIR
