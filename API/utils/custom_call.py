...
ORIGINAL_DATA_DIR = PATH_CONFIG.RESULT_ML_ORIGINAL_DATA_DIR
# 'result/ml_result/original_data'
PREPROCESSED_DATA_DIR = PATH_CONFIG.RESULT_ML_PREPROCESSED_DATA_DIR
# 'result/ml_result/preprocessed_data'
PREPROCESS_TRANSFORMER_DIR = PATH_CONFIG.RESULT_ML_PREPROCESS_TRANS_DIR
# 'result/ml_result/preprocess_transformer '
MODEL_DIR = PATH_CONFIG.RESULT_ML_MODEL_DIR
